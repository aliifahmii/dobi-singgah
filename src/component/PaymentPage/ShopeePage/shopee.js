...
function Shopee(props) {
    ...
    return (
        ...
        <div className="container-center-horizontal">
            <div className="spay screen">
                
                <div className="spay-1">
                    <Header title={title} />
                    
                    {/* Summary */}
                    <h1 className="titleSummary">{subtitle}</h1>
                    <div className="smallBoxSP">
                        <div className="rowHiddenSP">
                    ...
                    {/* SP Detail */}
                    <h1 className="titleSP">{subtitle2}</h1>
                    <div className="smallBoxSP-2">
                        <div className="timeOut">{timeOut} {minutes}:{seconds < 10 ? `0${seconds}` : seconds}</div>
                        <img className="shopeeLogo" src={logoShopee} alt="Shopee" />
                        <div className="transaction">{transactionInfo}</div>
                        <div className="terms">{terms}</div>

                        <div className="rowHiddenSP">
                            <button  className="buttonSPP" onClick={proceedPayment}>
                                <div className="buttonInfoSP">
                                    {proceedButton}
                                </div>
                            </button>
                            <button  className="buttonSPC" onClick={handleCancelTransaction}>
                                <div className="buttonInfoSP">
                                    {cancelButton}
                                </div>
                            </button>
