        ...
        <div className="container-center-horizontal">
            <div className="tng screen">
                ...
                <div className="tng-1">
                    ...
                    <div className="smallBoxTNG">
                        <div className="rowHiddenTNG">
                            <div className="summaryInfo">{netCharge}</div>
                            <div className="summaryDetail">RM {amount}.00</div>
                        </div>
                    ...
                    {/* TNG Detail */}
                    <h1 className="titleTNG">{subtitle2}</h1>
                    <div className="smallBoxTNG-2">
                        <div className="timeOut">{timeOut} {minutes}:{seconds < 10 ? `0${seconds}` : seconds}</div>
                        <img className="TNGLogo" src={logoTNG} alt="Touch'N Go" />
                        <div className="transaction">{transactionInfo}</div>
                        <div className="terms">{terms}</div>

                        <div className="rowHiddenTNG">
                            <button  className="buttonTNGP" onClick={proceedPayment}>
                                <div className="buttonInfoTNG">
                                    {proceedButton}
                                </div>
                            </button>
                            <button  className="buttonTNGC" onClick={handleCancelTransaction} >
                                <div className="buttonInfoTNG">
                                    {cancelButton}
                                </div>
                            </button>
