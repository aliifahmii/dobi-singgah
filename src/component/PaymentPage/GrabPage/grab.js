        ...
        <div className="container-center-horizontal">
            <div className="grab screen">
                ...
                <div className="grab-1">
                    ...
                    <div className="smallBoxGP">
                        <div className="rowHiddenGP">
                    ...
                    {/* GP Detail */}
                    <h1 className="titleGP">{subtitle2}</h1>
                    <div className="smallBoxGP-2">
                        <div className="timeOut">{timeOut} {minutes}:{seconds < 10 ? `0${seconds}` : seconds}</div>
                        <img className="grabLogo" src={logoGrab} alt="Grab" />
                        <div className="transaction">{transactionInfo}</div>
                        <div className="terms">{terms}</div>

                        <div className="rowHiddenGP">
                            <button  className="buttonGPP" onClick={proceedPayment}>
                                <div className="buttonInfoGP">
                                    {proceedButton}
                                </div>
                            </button>
                            <button  className="buttonGPC" onClick={handleCancelTransaction}>
                                <div className="buttonInfoGP">
                                    {cancelButton}
                                </div>
                            </button>
